...
execute if entity @s[scores={2layer=7}] if entity @s[scores={3layer=10..25}] run effect @s fire_resistance 60 0 true
execute if entity @s[scores={2layer=8}] run function lumetas_spell/effect/strength
execute if entity @s[scores={2layer=9}] if entity @s[scores={3layer=25}] run effect @s invisibility 60 3 true
execute if entity @s[scores={2layer=10}] if entity @s[scores={3layer=10..25}] run effect @s levitation 1 40 true
execute if entity @s[scores={2layer=11}] run function lumetas_spell/effect/resistance
